...
def wishme():
    ...
    speak("JARVIS AT YOUR SERVICE, I'M ONLINE AND READY!!!")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("im fine sir, thank you for asking")
            ...
            back_dir = 'file://C:/Users/DC/PycharmProjects/firstpProg/My Personal Assistant/back.mp3'
            os.startfile(back_dir)
